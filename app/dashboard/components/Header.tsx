      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="w-full">
          <CardContent className="p-4 flex flex-col h-full justify-between">
            ...
            <Separator className="my-2" />
            <div className="text-sm sm:text-base lg:text-lg text-muted-foreground text-center">
          ...
          <Card key={index} className="w-full">
            <CardContent className="p-4 flex flex-col h-full justify-between">
              <div className="flex items-center justify-between">
                ...
                <div className="text-[10px] sm:text-xs lg:text-sm text-muted-foreground font-bold">
              ...
              <div className="flex items-center justify-center p-2">
                {isLoading ? (
                  ...
                  <Progress
                    ...
                    className="w-full [&>*]:bg-gradient-to-r from-rose-500 to-amber-500 h-2"
                  />
                )}
              </div>
            </CardContent>
